...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Event.lastUpdated":
		if e.complexity.Event.LastUpdated == nil {
			break
		}

		return e.complexity.Event.LastUpdated(childComplexity), true
	...
	case "EventDay.lastUpdated":
		if e.complexity.EventDay.LastUpdated == nil {
			break
		}

		return e.complexity.EventDay.LastUpdated(childComplexity), true
...
func (ec *executionContext) _Event_lastUpdated(ctx context.Context, field graphql.CollectedField, obj *models.Event) (ret graphql.Marshaler) {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
...
func (ec *executionContext) _EventDay_lastUpdated(ctx context.Context, field graphql.CollectedField, obj *models.EventDay) (ret graphql.Marshaler) {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
...
func (ec *executionContext) _Match_players(ctx context.Context, field graphql.CollectedField, obj *models.Match) (ret graphql.Marshaler) {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalNPlayer2ᚕᚖgithubᚗcomᚋStarWarsDevᚋlegionᚑopsᚋinternalᚋgqlᚋmodelsᚐPlayerᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Event(ctx context.Context, sel ast.SelectionSet, obj *models.Event) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "lastUpdated":
			out.Values[i] = ec._Event_lastUpdated(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "name":
...
func (ec *executionContext) _EventDay(ctx context.Context, sel ast.SelectionSet, obj *models.EventDay) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "lastUpdated":
			out.Values[i] = ec._EventDay_lastUpdated(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "rounds":
...
func (ec *executionContext) _Match(ctx context.Context, sel ast.SelectionSet, obj *models.Match) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "players":
			out.Values[i] = ec._Match_players(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
...
func (ec *executionContext) marshalNPlayer2githubᚗcomᚋStarWarsDevᚋlegionᚑopsᚋinternalᚋgqlᚋmodelsᚐPlayer(ctx context.Context, sel ast.SelectionSet, v models.Player) graphql.Marshaler {
	return ec._Player(ctx, sel, &v)
}

func (ec *executionContext) marshalNPlayer2ᚕᚖgithubᚗcomᚋStarWarsDevᚋlegionᚑopsᚋinternalᚋgqlᚋmodelsᚐPlayerᚄ(ctx context.Context, sel ast.SelectionSet, v []*models.Player) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNPlayer2ᚖgithubᚗcomᚋStarWarsDevᚋlegionᚑopsᚋinternalᚋgqlᚋmodelsᚐPlayer(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
